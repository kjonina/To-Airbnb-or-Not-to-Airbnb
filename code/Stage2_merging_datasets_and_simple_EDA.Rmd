...
Lyons, R. (2021) *Irish Rental Report Q1 2024.* Available at: https://ww1.daft.ie/report/ronan-lyons-2024q1-daftrentalprice?d_rd=1 (Accessed: 17 December 2021).
...
unique_id_df <- df %>%
  group_by(id, rent_pressure_zone, lea, council, county, room_type, latitude, longitude) %>%
