...
file_path <- here("data", "listings.csv")
...
# specifying the path to the CSV file
file_path <- here("data", "summarise_df.csv")
...
# specifying the path to the CSV file
file_path <- here("data", "available_nights_df.csv")
...
# specifying the path to the CSV file
file_path <- here("data", "rent_pressure_zones.csv")
...
# specifying the path to the CSV file
file_path <- here("data", "rent_in_ireland.csv")
...
df <- df %>%
  mutate(annual_diff_rent_minus_Airbnb =rent_price_per_year -  total_income)
 
df %>%
    select(total_income, price, availability_365,rent_price_per_day, rent_price_per_month, rent_price_per_year, per_day_rent_AirBnB, per_year_rent_AirBnB) 
```
...
file_path <- here("data", "airbnb_final_df.csv")
...
###################
# Define the file path using here
file_path <- here("data", "airbnb_large_df.csv")
# Save the dataframe as a CSV file
