...
- summarise_df.csv - A new dataset from calendar.csv  was created, where listings were examined by availability for each month within a year (26th June 20 24 to 28th June 2025).
- available_nights_df.csv - A new dataset summarising the number of available nights for each listing in a year (26th June 20 24 to 28th June 2025).
...
A new dataset was created, where listings were examined by availability for each month within a year (26th June 20 24 to 28th June 2025).
```{r echo=FALSE}
...
A new dataset summarising the number of available nights for each listing in a year (26th June 20 24 to 28th June 2025).
