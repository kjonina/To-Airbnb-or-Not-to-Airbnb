...
counties_with_most_income_from_leasing <- function(table) { 
...
```{r warning=FALSE, echo=FALSE}
counties_with_most_income_from_leasing(entire_rpz_more_income_rent)
...
```{r echo=FALSE}
counties_with_most_income_from_leasing(private_room_rpz_more_income_rent)
